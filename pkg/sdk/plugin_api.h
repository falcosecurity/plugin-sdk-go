...
typedef struct {
	...
	struct {
		...
		//
		// Return this plugin's ability to extract field metadata. This
		// will be invoked only once by the framework after the plugin's
		// initialization.
		//
		// This function is optional. If NULL or 0, this indicates that
		// the plugin does not support metadata extraction.
