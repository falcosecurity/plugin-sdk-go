...
func plugin_extract_fields_sync(plgState C.uintptr_t, evt *C.ss_plugin_event_input, numFields uint32, fields *C.ss_plugin_extract_field, offsets *C.ss_plugin_extract_field_offsets) int32 {
	...
	for i = 0; i < numFields; i++ {
		...
		if offsets != nil {
			offs := (*[1 << 28]C.struct_ss_plugin_extract_field_offsets)(unsafe.Pointer(offsets))[:numFields:numFields]
